...
####
Ao se fazer os testes Qui-Quadrado de independência, encontrou-se envidências amostrais de que a variável RACACOR possa ser independente do número de mortes categorizado pelas CIDs da CAUSABAS. Os demais casos rejeitaram a hipótese de independência ($p < 0.05$).
