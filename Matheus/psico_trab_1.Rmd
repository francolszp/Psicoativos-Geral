...
####
Quando possível, foram contruídas tabelas de contingência relacionando cada grupo de CIDs com as variáveis socioeconômicas. Para testar a independência entre as variáveis socioeconômicas e as mortes relacionadas a um determinado grupo de CIDs, realizou-se o teste Qui-Quadrado de independência. O nível de confiança considerado foi de 5% ($p < 0.05$). Nos gráficos tipo mapa de calor as tonalidades mais escuras (cor azul) indicam baixas ou nenhuma ocorrência e as mais claras e fortes (cor amarela) indicam as maiores quantidades.
...
```
####
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável RACACOR. As mortes relacionadas com os grupos de CIDs (G312, G621 e G721) e (Y471, 494, Y499 e Y579) não  apresentaram  associação com a varíavel RACACOR. As demais CIDs se apresentaram estatísticamente associadas a cor de pele ($p < 0.05$), sugerindo assim que em grande parte das vezes a cor dos indivíduos pode ter influenciado em sua morte.
...
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável LOCOCOR. As mortes relacionadas com os grupos de CIDs (J703 e J704), (N141 e N142) e (Y471, 494, Y499 e Y579) não  apresentaram  associação com a varíavel LOCOCOR. As demais CIDs se apresentaram estatísticamente associadas ao local de morte ($p < 0.05$), sugerindo assim que na maioria dos casos o local em que o indivíduo estava pode ter influênciado na sua morte.
...
```
####
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável RACACOR. As mortes relacionadas com os grupos de CIDs (M342) e (R780-R785) não  apresentaram  associação com a varíavel RACACOR. As demais CIDs se apresentaram estatísticamente associadas a cor de pele ($p < 0.05$), sugerindo assim que em grande parte das vezes a cor dos indivíduos pode ter influenciado em sua morte.
...
####
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável SEXO. As mortes relacionadas com os grupos de CIDs (R780-R785), (N140-N142) e (M342) não apresentaram associação com a varíavel SEXO. As demais CIDs se apresentaram estatísticamente associadas a variável socioecômica em questão ($p < 0.05$), sugerindo assim que em grande parte das vezes o sexo dos indivíduos pode ter influenciado em sua morte.
...
####
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável ESTCIV. Somente as mortes relacionadas com os grupos de CIDs (R780-R785) e (P042-P044, P961 e Q860) não apresentaram associação com a varíavel ESTCIV. As demais CIDs se apresentaram estatísticamente associadas a variável socioecômica em questão ($p < 0.05$), sugerindo assim que em grande parte das vezes o estado civil dos indivíduos pode influenciar em sua morte.
...
Foi realizada uma análise de independência para investigar a relação entre o número de mortes por psicoativos e a variável LOCOCOR. Somente as mortes relacionadas com o grupo de CIDs (R780-R785) não  apresentaram  associação com a varíavel LOCOCOR. As demais CIDs se apresentaram estatísticamente associadas ao local de morte ($p < 0.05$), sugerindo assim que na maioria dos casos o local em que o indivíduo estava pode ter influênciado na sua morte.
...
####
No caso do Brasil, todas as variáveis socioeconômicas estavam associadas as mortes relacionadas ao grupo (R780-R785). O comportamento do ES é similar ao do Brasil no geral. A maioria das mortes tem relação com os grupos de CIDs (F100-F199 e F55) e (K292, K700-K709 e K860) no Brasil e no ES.
